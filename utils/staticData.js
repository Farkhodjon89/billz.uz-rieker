...
export class StaticDataSingleton {
  ...
  getRootCategories() {
    ...
    const menCategory = staticData.getCategoryBySlug("muzhskoj", 1);
    const womenCategory = staticData.getCategoryBySlug("zhenskij", 1);
    const boyCategory = staticData.getCategoryBySlug("malchik", 1);
    const girlCategory = staticData.getCategoryBySlug("devochka", 1);
